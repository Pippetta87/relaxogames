...
## Created: 2021-02-13
RCH=[0.22 0.24 0.26 0.30 0.37 0.49 0.64 1.00 1.32 1.75 2.30 2.75 3.19 3.56 3.88 4.07 4.19 4.25 4.28];
OCH=[1.26*10^8 8.034*10^7 5.135*10^7 3.286*10^7 2.10*10^7 1.34*10^7 8.59*10^6 5.49*10^6 3.51*10^6 2.25*10^6 1.44*10^6 9.17*10^5 5.87*10^5 3.75*10^5 2.4*10^5 1.54*10^5 9.86*10^4 6.24*10^4 4.05*10^4];
